...
// requires(*All values in the integer array parameter `nums` are greater than or equal to -10 and are less than or equal to 10.*);
// requires(*The integer array parameter `nums` is not equal to the null literal.*);
// ensures(*The integer result is equal to the maximum product of any contiguous subarray of the integer array parameter `nums`.*);
