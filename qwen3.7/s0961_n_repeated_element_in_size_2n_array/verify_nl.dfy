...
// ensures(*The integer result is equal to the value that appears exactly half the length of the integer array parameter `nums` times in the integer array parameter `nums`.*);
