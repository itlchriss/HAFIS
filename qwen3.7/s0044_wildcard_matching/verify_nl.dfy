...
// ensures(*If the boolean result is equal to the true literal, the string parameter `p` matches the entire string parameter `s` under the rules that the character '?' matches any single character and the character '*' matches any sequence of characters including the empty sequence.*);
// ensures(*If the boolean result is equal to the false literal, the string parameter `p` does not match the entire string parameter `s` under the rules that the character '?' matches any single character and the character '*' matches any sequence of characters including the empty sequence.*);
