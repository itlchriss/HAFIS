...
// requires(*The string parameter `num1` does not contain leading zeros.*);
// requires(*The string parameter `num2` does not contain leading zeros.*);
...
// ensures(*The string result is the sum of the non-negative integers represented by the string parameter `num1` and the string parameter `num2`.*);
