...
method subarraySum(nums: array<int>, k: int) returns (result: int)
{
    ...
    // ensures(*The integer result is equal to the total number of contiguous subarrays of the integer array parameter `nums` whose sum is equal to the integer parameter `k`.*);
