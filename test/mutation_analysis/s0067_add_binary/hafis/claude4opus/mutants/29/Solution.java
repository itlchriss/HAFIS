...
//@ requires(\forall int i; 0 <= i < b.length(); b.charAt(i) == '0' || b.charAt(i) == '1');
//@ requires(\forall int i; 0 <= i < a.length(); a.charAt(i) == '0' || a.charAt(i) == '1');
//@ requires((a.length() >= 1) && (a.length() <= 10000));
//@ requires((b.length() >= 1) && (b.length() <= 10000));
//@ ensures(\forall int i; 0 <= i < \result.length(); \result.charAt(i) == '0' || \result.charAt(i) == '1');
