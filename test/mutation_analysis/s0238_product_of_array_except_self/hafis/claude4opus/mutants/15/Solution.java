...
//@ requires((nums.length >= 2) && (nums.length <= 100000));
...
//@ ensures((\forall int i; 0 <= i < \result.length; \result[i] >= -2147483648) && (\forall int i; 0 <= i < \result.length; \result[i] <= 2147483647));
