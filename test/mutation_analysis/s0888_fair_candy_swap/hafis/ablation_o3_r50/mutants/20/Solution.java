...
//@ requires((\forall int i; 0 <= i < bobSizes.length; bobSizes[i] >= 1) && (\forall int i; 0 <= i < bobSizes.length; bobSizes[i] <= 100000));
//@ requires((bobSizes.length >= 1) && (bobSizes.length <= 10000));
//@ requires((\forall int i; 0 <= i < aliceSizes.length; aliceSizes[i] >= 1) && (\forall int i; 0 <= i < aliceSizes.length; aliceSizes[i] <= 100000));
