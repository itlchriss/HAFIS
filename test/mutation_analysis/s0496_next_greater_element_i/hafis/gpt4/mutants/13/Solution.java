...
//@ requires(\forall int i; 0 <= i < nums1.length; \exists int j; 0 <= j < nums2.length; nums2[j] == nums1[i]);
//@ requires((\forall int i; 0 <= i < nums2.length; nums2[i] <= 10000) && (\forall int i; 0 <= i < nums2.length; nums2[i] >= 0));
//@ requires((\forall int i; 0 <= i < nums1.length; nums1[i] <= 10000) && (\forall int i; 0 <= i < nums1.length; nums1[i] >= 0));
//@ requires((nums1.length <= nums2.length) && (nums1.length >= 1));
//@ requires((nums2.length <= 1000) && (nums2.length >= 1));
