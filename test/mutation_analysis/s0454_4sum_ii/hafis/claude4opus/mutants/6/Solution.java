...
//@ requires(nums2.length == nums3.length);
//@ requires(nums1.length == nums2.length);
//@ requires(nums3.length == nums4.length);
//@ requires((\forall int i; 0 <= i < nums1.length; nums1[i] >= -268435456) && (\forall int i; 0 <= i < nums1.length; nums1[i] <= 268435456));
//@ requires((nums4.length >= 1) && (nums4.length <= 200));
//@ requires((nums3.length >= 1) && (nums3.length <= 200));
//@ requires((nums1.length >= 1) && (nums1.length <= 200));
//@ requires((nums2.length >= 1) && (nums2.length <= 200));
//@ ensures(\result >= 0);
