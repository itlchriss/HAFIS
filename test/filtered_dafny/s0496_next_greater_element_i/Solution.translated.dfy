...
requires (nums1.length <= 1000) && (nums1.length >= 1)
requires (nums1.size() <= 1000) && (nums1.size() >= 1)
requires (nums1.length() <= 1000) && (nums1.length() >= 1)
requires (nums1.size() <= 1000) && (nums1.size() >= 1)
...
requires \exists int i; 0 <= i < nums2.length; nums2[i] == \forall int i; 0 <= i < nums1.length; nums1[i]
ensures \result.length == nums1.length
ensures \result.length == nums1.length
ensures \result.length == nums1.size()
ensures \result.length == nums1.length()
ensures \result.length == nums1.size()
