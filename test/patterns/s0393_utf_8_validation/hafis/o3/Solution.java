...
//@ ensures(*If the boolean result is equal to the true literal, the integer array parameter `data` represents a valid UTF-8 encoded sequence of bytes.*);
//@ ensures(*If the boolean result is equal to the false literal, the integer array parameter `data` does not represent a valid UTF-8 encoded sequence of bytes.*);
