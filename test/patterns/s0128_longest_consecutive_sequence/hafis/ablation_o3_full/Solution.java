...
//@ ensures(*int result equals the length of the longest sequence of consecutive integer values that can be formed from the elements of int[] `nums`*);
//@ ensures(*int result equals 0 when int[] `nums` has a length of 0*);
