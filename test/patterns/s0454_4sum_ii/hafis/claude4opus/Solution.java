...
//@ requires(*The length of the integer array parameter `nums2` is equal to the length of the integer array parameter `nums3`.*);
//@ requires(*The length of the integer array parameter `nums3` is equal to the length of the integer array parameter `nums4`.*);
