...
//@ ensures(*The integer result is less than or equal to the length of the integer array parameter `nums1` multiplied by the length of the integer array parameter `nums2` multiplied by the length of the integer array parameter `nums3` multiplied by the length of the integer array parameter `nums4`.*);
...
//@ ensures(*If the integer result is equal to 0, the sum of one value from the integer array parameter `nums1`, one value from the integer array parameter `nums2`, one value from the integer array parameter `nums3`, and one value from the integer array parameter `nums4` is never equal to 0.*);
