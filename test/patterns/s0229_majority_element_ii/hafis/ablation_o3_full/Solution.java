...
//@ ensures(*result List<Integer> is produced for any valid 'nums' int[] input*);
//@ ensures(*result List<Integer> contains every integer that appears in 'nums' int[] more than the integer part of the length of 'nums' int[] divided by three*);
//@ ensures(*result List<Integer> contains no integer that appears in 'nums' int[] at most the integer part of the length of 'nums' int[] divided by three*);
//@ ensures(*result List<Integer> contains no duplicate integers*);
