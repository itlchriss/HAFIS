...
//@ ensures(*If the integer array parameter `nums` is equal to [3,2,3], the list result contains 3.*);
//@ ensures(*If the integer array parameter `nums` is equal to [1], the list result contains 1.*);
//@ ensures(*If the integer array parameter `nums` is equal to [1,2], the list result contains 1 and 2.*);
