...
//@ requires(*The string parameter `preorder` consists of integers in the range 0 to 100 and '#' characters separated by commas.*);
//@ requires(*The string parameter `preorder` does not contain two consecutive commas.*);
//@ requires(*The string parameter `preorder` does not contain empty values between commas.*);
