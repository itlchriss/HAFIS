...
//@ requires(*The string parameter `s` consists only of uppercase English letters lowercase English letters and digits.*);
//@ ensures(*The length of the string result is equal to the length of the string parameter `s`.*);
//@ ensures(*For every two distinct characters that occur in the string parameter `s`, if the frequency of the first character in the string parameter `s` is greater than the frequency of the second character in the string parameter `s`, every occurrence of the first character appears in the string result before any occurrence of the second character.*);
//@ ensures(*For each distinct character that occurs in the string parameter `s`, all of its occurrences appear consecutively in the string result.*);
