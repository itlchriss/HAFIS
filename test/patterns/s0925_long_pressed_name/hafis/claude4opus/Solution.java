...
//@ ensures(*If the boolean result is equal to the true literal, all characters in the string parameter `name` appear in the string parameter `typed` in the same order.*);
//@ ensures(*If the boolean result is equal to the true literal, the length of the string parameter `typed` is greater than or equal to the length of the string parameter `name`.*);
//@ ensures(*If the boolean result is equal to the false literal, the string parameter `typed` does not contain all characters from the string parameter `name` in the same order or the count of some character in the string parameter `typed` is less than the count of the same character in the string parameter `name`.*);
