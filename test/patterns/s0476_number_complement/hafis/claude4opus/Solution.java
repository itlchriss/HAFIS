...
//@ ensures(*The sum of the integer parameter `num` and the integer result is equal to 2 raised to the power of the number of bits in the binary representation of the integer parameter `num` minus 1.*);
