...
//@ ensures(*The integer result is equal to the total count of the digit 1 in the decimal representations of all integers greater than or equal to 0 and less than or equal to the integer parameter `n`.*);
