...
//@ ensures(*The integer result is less than or equal to the integer parameter `n`.*);
//@ ensures(*If the integer parameter `n` is less than 1, the integer result is equal to 0.*);
