...
//@ ensures(*For every index i that is greater than or equal to 0 and is less than the length of the integer array parameter `nums`, the integer value at index i of the integer array result is equal to the product of all integer values in the integer array parameter `nums` except the value at index i.*);
