...
//@ ensures(*The integer result is greater than or equal to -1 and is less than or equal to the maximum between the length of the string parameter `a` and the length of the string parameter `b`*);
