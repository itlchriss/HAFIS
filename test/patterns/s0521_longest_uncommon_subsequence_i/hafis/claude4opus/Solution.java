...
//@ ensures(*If the string parameter `a` is not equal to the string parameter `b`, the integer result is equal to the maximum between the length of the string parameter `a` and the length of the string parameter `b`.*);
