...
//@ ensures(*If the integer result is equal to -1, the integer parameter `target` is not in the integer array parameter `nums`.*);
//@ ensures(*If the integer result is greater than or equal to 0, the value at index integer result in the integer array parameter `nums` is equal to the integer parameter `target`.*);
