...
//@ ensures(*int result equals the zero based index at which int "target" appears in int[] "nums" when int "target" is present*);
//@ ensures(*int result equals minus one when int "target" is absent from int[] "nums"*);
//@ ensures(*int result is never less than zero and never greater than the length of int[] "nums" minus one when int "target" is present*);
//@ ensures(*int result satisfies the condition that int[] "nums" at position result equals int "target" when int "target" is present*);
