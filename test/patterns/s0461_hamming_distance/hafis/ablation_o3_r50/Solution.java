...
//@ requires(*The integer parameter `y` is greater than or equal to 0 and is less than or equal to the maximum value of java integer*);
//@ ensures(*The integer result is greater than or equal to 0 and is less than or equal to 31*);
//@ ensures(*The integer result is equal to the number of bit positions where the binary representation of the integer parameter `x` and the binary representation of the integer parameter `y` are different*);
