...
//@ ensures(*The integer result is equal to the count of bit positions where the binary representation of the integer parameter `x` differs from the binary representation of the integer parameter `y`.*);
