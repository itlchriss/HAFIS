...
//@ ensures(*If the length of the integer array parameter `nums` is less than or equal to 1, the integer result is equal to 0.*);
//@ ensures(*The integer result is equal to the maximum difference between two successive elements in the sorted order of the integer array parameter `nums`.*);
