...
//@ ensures(*If boolean result is equal to the true literal, there exists an integer x such that the integer parameter `n` is equal to 3 raised to the power of x and the integer parameter `n` is greater than 0.*);
//@ ensures(*If boolean result is equal to the false literal, the integer parameter `n` is not equal to any integer power of 3.*);
