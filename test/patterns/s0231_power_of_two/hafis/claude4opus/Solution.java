...
//@ ensures(*If the boolean result is equal to the true literal, the integer parameter `n` is a power of 2.*);
//@ ensures(*If the boolean result is equal to the false literal, the integer parameter `n` is not a power of 2.*);
