...
//@ ensures(*If the decimal digits of the integer parameter `x` reversed form an integer that is greater than or equal to the minimum value of java integer and is less than or equal to the maximum value of java integer, the integer result is equal to that reversed integer.*);
//@ ensures(*If the decimal digits of the integer parameter `x` reversed form an integer that is less than the minimum value of java integer or is greater than the maximum value of java integer, the integer result is equal to 0.*);
