...
//@ ensures(*If the integer parameter `x` is greater than 0 and the integer result is greater than 0, the integer result has the same digits as the integer parameter `x` in reverse order.*);
//@ ensures(*If the integer parameter `x` is less than 0 and the integer result is less than 0, the absolute value of the integer result has the same digits as the absolute value of the integer parameter `x` in reverse order.*);
//@ ensures(*If reversing the digits of the integer parameter `x` would cause the value to be less than -2147483648 or greater than 2147483647, the integer result is equal to 0.*);
