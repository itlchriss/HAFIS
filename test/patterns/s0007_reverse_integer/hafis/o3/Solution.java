...
//@ ensures(*If the integer result is equal to 0 and the integer parameter `x` is not equal to 0, reversing the digits of the integer parameter `x` produces a value greater than the maximum value of java integer or produces a value less than the minimum value of java integer.*);
