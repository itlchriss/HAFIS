...
//@ requires(*The string parameter `s` is less than or equal to 100 and is greater than or equal to 1.*);
//@ requires(*The string parameter `s` contains only digits and may contain leading zero(s).*);
