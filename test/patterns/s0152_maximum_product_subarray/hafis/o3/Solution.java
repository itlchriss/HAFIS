...
//@ ensures(*There exists a contiguous non empty subsequence of the integer array parameter `arr` such that the integer result is equal to the product of all values in that subsequence.*);
//@ ensures(*For every contiguous non empty subsequence of the integer array parameter `arr`, the integer result is greater than or equal to the product of all values in that subsequence.*);
