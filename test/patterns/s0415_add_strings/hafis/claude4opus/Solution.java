...
//@ requires(*The string parameter `num1` does not have leading zeros except when the string parameter `num1` is equal to "0".*);
//@ requires(*The string parameter `num2` does not have leading zeros except when the string parameter `num2` is equal to "0".*);
//@ ensures(*The string result represents the sum of the integer value of the string parameter `num1` and the integer value of the string parameter `num2`.*);
//@ ensures(*The string result consists of only digits.*);
//@ ensures(*The string result does not have leading zeros except when the string result is equal to "0".*);
