...
//@ requires(*The string parameter `num1` does not contain leading zeros except the string parameter `num1` is equal to "0".*);
//@ requires(*The string parameter `num2` does not contain leading zeros except the string parameter `num2` is equal to "0".*);
...
//@ ensures(*The string result does not contain leading zeros except the string result is equal to "0".*);
