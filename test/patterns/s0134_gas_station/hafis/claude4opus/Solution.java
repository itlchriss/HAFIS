...
//@ ensures(*The integer result is less than or equal to the length of the integer array parameter `gas` minus 1 and is greater than or equal to -1.*);
...
//@ ensures(*If the integer result is greater than or equal to 0, the integer result is less than the length of the integer array parameter `gas`.*);
//@ ensures(*If the sum of all values in the integer array parameter `gas` is less than the sum of all values in the integer array parameter `cost`, the integer result is equal to -1.*);
