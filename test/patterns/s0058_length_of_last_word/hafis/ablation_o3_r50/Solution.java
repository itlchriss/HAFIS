...
//@ ensures(*If the string parameter `s` contains no space character, the integer result is equal to the length of the string parameter `s`.*);
//@ ensures(*If the last character of the string parameter `s` is equal to the space character literal, the integer result is equal to the length of the last word in the string parameter `s`.*);
