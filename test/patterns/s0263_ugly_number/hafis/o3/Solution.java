...
//@ ensures(*If boolean result is equal to the true literal, the integer parameter `n` is greater than 0 and all prime factors of the integer parameter `n` belong to the set 235.*);
//@ ensures(*If boolean result is equal to the false literal, the integer parameter `n` is less than or equal to 0 or at least one prime factor of the integer parameter `n` does not belong to the set 235.*);
