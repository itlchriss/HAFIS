...
//@ ensures(*All uppercase letters in the string result are converted to their corresponding lowercase letters.*);
//@ ensures(*All non-uppercase letters in the string result remain unchanged from the string parameter `s`.*);
