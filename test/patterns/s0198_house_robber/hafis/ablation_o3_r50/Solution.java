...
//@ ensures(*The integer result is equal to the maximum obtainable sum of elements chosen from the integer array parameter `nums` under the condition that no two chosen elements are adjacent within the integer array parameter `nums`.*);
