...
//@ ensures(*The integer result is less than or equal to the difference between the maximum value and the minimum value in the integer array parameter `nums`.*);
