...
//@ ensures(*The integer result is less than or equal to the difference between the maximum value of the integer array parameter `nums` and the minimum value of the integer array parameter `nums`.*);
