...
//@ requires(*The string parameter `a` does not contain leading zeros except when the string parameter `a` is equal to "0".*);
//@ requires(*The string parameter `b` does not contain leading zeros except when the string parameter `b` is equal to "0".*);
//@ ensures(*The string result consists only of the characters 0 and 1.*);
//@ ensures(*The string result interpreted as a binary integer is equal to the sum of the binary integers represented by the string parameters `a`and`b`.*);
