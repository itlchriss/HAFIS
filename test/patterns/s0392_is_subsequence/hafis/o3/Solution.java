...
//@ ensures(*If boolean result is equal to the true literal, the string parameter `s` is a subsequence of the string parameter `t`.*);
//@ ensures(*If boolean result is equal to the false literal, the string parameter `s` is not a subsequence of the string parameter `t`.*);
