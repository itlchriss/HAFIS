...
//@ ensures(*If the string parameter `s` is empty, the boolean result is equal to the true literal.*);
...
//@ ensures(*If the length of the string parameter `s` is greater than the length of the string parameter `t`, the boolean result is equal to the false literal.*);
