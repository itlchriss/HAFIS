...
//@ ensures(*The string result should not contain leading or trailing spaces.*);
//@ ensures(*The string result should only have a single space separating the words.*);
//@ ensures(*Multiple spaces between two words in the string result should be reduced to a single space.*);
