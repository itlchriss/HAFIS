...
//@ ensures(*The integer result is greater than or equal to the maximum value in the integer array parameter `nums`.*);
//@ ensures(*If the length of the integer array parameter `nums` is equal to 1, the integer result is equal to the first element of the integer array parameter `nums`.*);
