...
//@ ensures(*The integer result is less than or equal to 1000000000 and is greater than or equal to -1000000000.*);
//@ ensures(*The integer result is equal to the maximum value between all the products obtained by multiplying any three distinct values in the integer array parameter `nums`.*);
