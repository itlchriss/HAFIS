...
//@ ensures(*The integer result is greater than or equal to the product of any three distinct values in the integer array parameter `nums`.*);
//@ ensures(*There exist three indices of the integer array parameter `nums` such that the product of the three corresponding values is equal to the integer result.*);
