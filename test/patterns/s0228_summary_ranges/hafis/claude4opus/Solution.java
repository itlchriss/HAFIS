...
//@ ensures(*All strings in the list result contain either a single integer or two integers separated by "->".*);
//@ ensures(*The length of the list result is less than or equal to the length of the integer array parameter `nums`.*);
