...
//@ ensures(*The integer result is greater than or equal to 0 and is less than or equal to the quotient between the product between the length of the integer array parameter `nums` and the sum between the length of the integer array parameter `nums` and 1 and 2.*);
//@ ensures(*The integer result is equal to the total number of continuous subarrays of the integer array parameter `nums` whose sum is equal to the integer parameter `k`.*);
