...
//@ requires(*All values in the integer array parameter `g` are less than or equal to 2147483647 and are greater than or equal to 1.*);
//@ requires(*All values in the integer array parameter `s` are less than or equal to 2147483647 and are greater than or equal to 1.*);
...
//@ ensures(*The integer result is less than or equal to the length of the integer array parameter `s`.*);
