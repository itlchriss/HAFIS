...
//@ ensures(*If the boolean result is equal to true, the pattern parameter `pattern` matches the entire input string parameter `inputString`.*);
//@ ensures(*If the boolean result is equal to false, the pattern parameter `pattern` does not match the entire input string parameter `inputString`.*);
