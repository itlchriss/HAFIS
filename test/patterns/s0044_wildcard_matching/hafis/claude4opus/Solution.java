...
//@ requires(*The string parameter `inputString` contains only lowercase English letters.*);
//@ requires(*The string parameter `pattern` contains only lowercase English letters, '?' or '*'.*);
...
//@ ensures(*If the boolean result is equal to the true literal and the string parameter `pattern` does not contain '*' and does not contain '?', the string parameter `inputString` is equal to the string parameter `pattern`.*);
//@ ensures(*If the boolean result is equal to the true literal and the string parameter `pattern` does not contain '*', the length of the string parameter `inputString` is equal to the length of the string parameter `pattern`.*);
