...
//@ requires(*The string parameter `version1` consists only of digits and the character '.'.*);
//@ requires(*The string parameter `version2` consists only of digits and the character '.'.*);
//@ requires(*The string parameter `version1` is a valid version number.*);
//@ requires(*The string parameter `version2` is a valid version number.*);
//@ ensures(*The integer result is equal to -1 or is equal to 0 or is equal to 1.*);
//@ ensures(*If the integer result is equal to 0, all corresponding revisions in the string parameter `version1` and the string parameter `version2` have equal integer values after treating unspecified revisions as 0.*);
//@ ensures(*If the integer result is equal to 1, the first differing revision between the string parameter `version1` and the string parameter `version2` has an integer value in the string parameter `version1` that is greater than the integer value in the string parameter `version2`.*);
//@ ensures(*If the integer result is equal to -1, the first differing revision between the string parameter `version1` and the string parameter `version2` has an integer value in the string parameter `version1` that is less than the integer value in the string parameter `version2`.*);
