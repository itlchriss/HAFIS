...
//@ requires(*The string parameter `version1` only contains digits and '.'.*);
//@ requires(*The string parameter `version2` only contains digits and '.'.*);
//@ ensures(*The integer result is equal to -1,0, or 1.*);
