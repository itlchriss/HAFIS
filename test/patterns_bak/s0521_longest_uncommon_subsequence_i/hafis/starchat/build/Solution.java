...
public class Solution {
     ...
     */
//@ ensures((b.equals("aaa")) ==> ((b.equals("aaa")) && (\result == -1)));
//@ ensures((a.equals("aaa")) ==> ((b.equals("aaa")) && (\result == -1)));
//@ ensures((\result == -1) ==> ((b.contains(a)) && (a.contains(b))));
//@ ensures((b.equals("aaa")) ==> (\result == -1));
//@ ensures((a.equals("aaa")) ==> (\result == -1));
//@ ensures((a.equals("aaa")) ==> ((b.equals("bbb")) && (\result == 3)));
//@ ensures((b.equals("aaa")) ==> ((b.equals("bbb")) && (\result == 3)));
//@ ensures((b.equals("aba")) ==> (\result == 3));
//@ ensures((a.equals("aba")) ==> (\result == 3));
