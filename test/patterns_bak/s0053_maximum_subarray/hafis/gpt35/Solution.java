...
//@ requires(*The integer array parameter `nums` is less than or equal to 100000 and is greater than or equal to 1.*);
...
//@ ensures(*The integer result is equal to the sum of the largest sum contiguous subarray in the integer array parameter `nums`.*);
