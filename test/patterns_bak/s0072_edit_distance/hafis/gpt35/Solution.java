...
//@ requires(*The string parameter `w1` and `w2` consist of only lowercase English letters.*);
//@ ensures(*The integer result is the minimum number of operations required to convert `w1` to `w2`.*);
